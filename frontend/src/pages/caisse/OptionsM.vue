...
export default {
  ...
  async created() {
    const num_modal = this.caisse.id_caisse;
    this.show_button =
      "<button type='button' class='badge bg-primary' data-bs-toggle='modal' data-bs-target='#showModal" +
      num_modal +
      "'><i class='bx bxs-badge-dollar'></i> Voir plus</button>";
  },
};
</script>
